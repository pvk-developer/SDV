...
def test___init__passes_correct_parameters(metadata_mock):
    ...
    Input:
    - learn_rounding_scheme set to an int
    ...
    """
    # Run
    GaussianCopula(learn_rounding_scheme=True, enforce_min_max_values=True)
    CTGAN(epochs=1, learn_rounding_scheme=True, enforce_min_max_values=True)
    TVAE(epochs=1, learn_rounding_scheme=True, enforce_min_max_values=True)
    CopulaGAN(epochs=1, learn_rounding_scheme=True, enforce_min_max_values=True)
    ...
    expected_calls = [
        call(field_names=None, primary_key=None, field_types=None, field_transformers=None,
             ...
             dtype_transformers={'O': 'categorical_fuzzy'}, learn_rounding_scheme=True,
